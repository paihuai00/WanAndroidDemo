...
public class XViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public XViewHolder setImageUrl(Context context, @IdRes int viewId, Object imageUrl) {
        ImageView view = getView(viewId);
        XImage.load(context, view, imageUrl);
        return this;
    }

    public XViewHolder setImageUrl(Context context, @IdRes int viewId, Object imageUrl, int defaultImage) {
        ImageView view = getView(viewId);
        XImage.load(context, view, imageUrl, defaultImage);
        return this;
    }

    public XViewHolder setImageUrl(Context context, @IdRes int viewId, Object imageUrl, Object transformation) {
        ImageView view = getView(viewId);
        XImage.load(context, view, imageUrl, transformation);
        return this;
    }

    public XViewHolder setImageUrl(Context context, @IdRes int viewId, Object imageUrl, int defaultImage, Object transformation) {
        ImageView view = getView(viewId);
        XImage.load(context, view, imageUrl, transformation, defaultImage);
        return this;
    }
...
//    }
    ...
    public boolean onLongClick(View v) {
        if (onItemChildLongClickListener != null && v.getId() != this.itemView.getId()) {
            onItemChildLongClickListener.onItemChildLongClick(this, v, getAdapterPosition());
            return true;
        }
        return false;
    }
    ...
    public void onClick(View v) {
        if (onItemChildClickListener != null && v.getId() != this.itemView.getId()) {
            onItemChildClickListener.onItemChildClick(this, v, getAdapterPosition());
        }
    }

    public XRecyclerViewAdapter.OnItemChildLongClickListener getOnItemChildLongClickListener() {
    ...
    public XRecyclerViewAdapter.OnItemChildClickListener getOnItemChildClickListener() {
