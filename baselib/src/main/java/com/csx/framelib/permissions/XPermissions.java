package com.csx.framelib.permissions;
...
public final class XPermissions {
    ...
    private XPermissions(Activity activity) {
        mActivity = activity;
    }
     ...
     * 设置请求的对象
     */
    public static XPermissions with(Activity activity) {
        return new XPermissions(activity);
    }

    /**
     * 设置权限组
     */
    public XPermissions permission(String... permissions) {
     ...
     * 设置权限组
     */
    public XPermissions permission(List<String> permissions) {
     ...
     * 被拒绝后继续申请，直到授权或者永久拒绝
     */
    public XPermissions constantRequest() {
        mConstant = true;
        return this;
    }
